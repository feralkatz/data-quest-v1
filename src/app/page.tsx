    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <main className="relative px-4 py-10 sm:px-6 sm:py-14">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <p className="mb-3 inline-block rounded-full bg-white/60 px-4 py-1.5 text-sm font-medium text-rose-600 shadow-sm backdrop-blur-sm">
      ...
      <footer className="relative border-t border-white/40 bg-white/20 px-6 py-6 text-center backdrop-blur-sm">
